...
Minesweeper::Minesweeper(int rows, int cols, int num_mines) : rows(rows), cols(cols), num_mines(num_mines), board(rows, std::vector<int>(cols, 0)), revealed(rows, std::vector<bool>(cols, false)), flagged(rows, std::vector<bool>(cols, false)) {}
...
void Minesweeper::reveal_tile(int row, int col) {
...
void Minesweeper::flag_tile(int row, int col) {
